...
public class PrimitiveTypesSubject extends AutoPrimitiveTypesSubject {
    ...
    public static AssertionError expectFailure(
        @Nonnull SimpleSubjectBuilderCallback<PrimitiveTypesSubject, PrimitiveTypes> callback) {
