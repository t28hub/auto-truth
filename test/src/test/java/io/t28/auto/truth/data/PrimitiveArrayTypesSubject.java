...
public class PrimitiveArrayTypesSubject extends AutoPrimitiveArrayTypesSubject {
    ...
    public static AssertionError expectFailure(
        @Nonnull SimpleSubjectBuilderCallback<PrimitiveArrayTypesSubject, PrimitiveArrayTypes> callback) {
