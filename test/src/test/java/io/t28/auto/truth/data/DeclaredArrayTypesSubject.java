...
public class DeclaredArrayTypesSubject extends AutoDeclaredArrayTypesSubject {
    ...
    public static AssertionError expectFailure(
        @Nonnull SimpleSubjectBuilderCallback<DeclaredArrayTypesSubject, DeclaredArrayTypes> callback) {
