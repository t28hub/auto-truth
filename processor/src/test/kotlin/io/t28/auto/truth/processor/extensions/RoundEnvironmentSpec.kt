...
object RoundEnvironmentSpec : Spek({
    describe("RoundEnvironment") {
        describe("getAnnotatedElements") {
            it("should return set of annotated element") {
            ...
            it("should return empty set when no annotated element") {
                process(Resource.User, Resource.UserSubject) { context ->
                    // Act
