...
public class AutoVoidValueObjectSubject extends Subject {
    private final VoidValueObject actual;

    AutoVoidValueObjectSubject(FailureMetadata failureMetadata, VoidValueObject actual) {
